...
type SidebarProps = {
  ...
  tabs: Tab[];
  tabGroups?: Array<{ id: string; name: string; tabs: Tab[]; isAutoGenerated: boolean }>;
  ungroupedTabs?: Tab[];
    ...
    <aside className="sidebar">
      ...
      <div className="tabs-section">
        <div className="tabs-section-header">
          ...
          <div className="tabs-section-actions">
            <button className="tabs-section-btn tidy" type="button" onClick={onTidyUp}>
              Tidy Up
            </button>
          ...
          <div className="tabs-groups">
            ...
            {ungroupedTabs.length > 0 && (
              <div className="tab-group">
                <div className="tab-group-header">
                  <span className="tab-group-title">Other Tabs</span>
                  <span className="tab-group-count">{ungroupedTabs.length}</span>
                </div>
                <TabStrip
                  tabs={ungroupedTabs}
                  onActivate={onActivateTab}
